...
update ordinances set
  ...
  summary =
    ...
    || '12 April 2024. Covers shielding, light trespass, lighting color, hours '
...
update cities set
  ordinance_notes =
    ...
    || 'color temperature is capped at 4000K rather than 3000K; sports and '
...
update cities set
  ordinance_notes =
    ...
    || 'less, and requires fixture types, locations and controls to minimize '
    || 'glare, light trespass and artificial sky glow. Both a shielding mandate '
    || 'and a color temperature cap, which is more than most California city '
    || 'codes carry.',
  code_reviewed_at = '2026-08-08',
...
update cities set
  ordinance_notes =
    ...
    || 'neighboring properties. Full cutoff is the defining dark sky '
    || 'requirement. No color temperature cap or curfew, so there is room to '
...
update cities set
  ordinance_notes =
    ...
    || 'preserve the night sky" outdoor fixtures shall minimize glare, upward '
    ...
    || 'discretionary rather than a shielding mandate, with no color '
